                ...
                travelers.map((traveler) => (
                  ...
                  >
                    ...
                    {traveler.passport_number && (
                      <p className="text-sm text-muted-foreground">Passport: {traveler.passport_number}</p>
                    )}
                  </div>
                ))
              )}
                ...
                checklist.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p
                        className={`text-sm font-medium ${item.is_completed ? 'line-through text-muted-foreground' : 'text-foreground'}`}
                      >
                        {item.item_name}
                      </p>
                      {item.due_date && (
