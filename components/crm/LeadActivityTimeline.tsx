...
const ACTIVITY_CONFIG: Record<string, { icon: React.ComponentType<{ className?: string }>; color: string; bg: string }> = {
  lead_created:       { icon: Star,        color: 'text-teal-600',   bg: 'bg-teal-100' },
  lead_updated:       { icon: FileText,    color: 'text-blue-600',   bg: 'bg-blue-100' },
  ...
  call_made:          { icon: Phone,       color: 'text-blue-600',   bg: 'bg-blue-100' },
  ...
  assigned:           { icon: User,        color: 'text-teal-600',   bg: 'bg-teal-100' },
  ...
  duplicated:         { icon: Copy,        color: 'text-blue-600',   bg: 'bg-blue-100' },
  quotation_generated:{ icon: FileText,    color: 'text-teal-600',   bg: 'bg-teal-100' },
}
            ...
            <div className="flex-1 pb-4 min-w-0">
              ...
              {activity.performer && (
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span className="text-[11px] text-gray-400">{activity.performer.full_name}</span>
                </div>
              )}
            </div>
          </motion.div>
