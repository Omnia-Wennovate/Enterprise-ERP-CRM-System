      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[210] w-[460px] bg-white rounded-2xl shadow-2xl border border-gray-200"
          >
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              <div>
                <h2 className="font-bold text-gray-900">Convert Lead</h2>
              ...
              {done ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-start gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-teal-400 hover:bg-teal-50 transition-all text-left group"
                  >
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Convert to Customer</p>
                      <p className="text-xs text-gray-500 mt-0.5">Create a new customer profile in the CRM using this lead&apos;s data</p>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    disabled={converting !== null}
                    className="w-full flex items-start gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all text-left group"
                  >
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Convert to Booking</p>
                      <p className="text-xs text-gray-500 mt-0.5">Open the new booking form pre-filled with this lead&apos;s travel details</p>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    disabled={converting !== null}
                    className="w-full flex items-start gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-purple-400 hover:bg-purple-50 transition-all text-left group"
                  >
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Generate Quotation</p>
                      <p className="text-xs text-gray-500 mt-0.5">Create a draft quotation from this lead&apos;s requirements</p>
                    </div>
                  </button>
                </>
              )}
