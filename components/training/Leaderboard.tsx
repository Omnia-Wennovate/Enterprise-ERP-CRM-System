    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-card p-6 rounded-xl border border-border/80 shadow-sm">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Recognizing top learners across the organization.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="bg-muted p-1 rounded-lg flex items-center">
            <button
              ...
              className={`px-4 py-1.5 text-sm font-medium rounded-md transition-colors ${
                view === 'company' ? 'bg-card text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'
              }`}
            >
              Company
            </button>
            <button
              ...
              className={`px-4 py-1.5 text-sm font-medium rounded-md transition-colors ${
                view === 'department' ? 'bg-card text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'
              }`}
            >
              Department
            </button>
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-3 py-1.5 border rounded-lg text-sm font-medium transition-colors ${
              optedOut ? 'bg-sidebar border-slate-800 text-primary-foreground' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'
            }`}
      ...
      {!loading && entries.length >= 3 && (
        <div className="grid grid-cols-3 gap-4 pt-8 pb-4 items-end">
          ...
          <motion.div 
            ...
            className="bg-card rounded-t-2xl border-t border-x border-border/80 p-6 flex flex-col items-center relative shadow-[0_-10px_20px_-15px_rgba(0,0,0,0.1)] h-48 justify-end"
          >
            <div className="absolute -top-10 flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-slate-200 border-4 border-border shadow-lg flex items-center justify-center text-muted-foreground font-bold text-xl overflow-hidden">
          ...
          >
            <div className="absolute -top-12 flex flex-col items-center">
              ...
              <div className="w-20 h-20 rounded-full bg-slate-200 border-4 border-amber-400 shadow-xl flex items-center justify-center text-muted-foreground font-bold text-2xl overflow-hidden">
              ...
              <div className="w-8 h-8 rounded-full bg-amber-400 border-2 border-white flex items-center justify-center text-primary-foreground font-bold -mt-4 shadow-sm">1</div>
            </div>
          ...
          <motion.div 
            ...
            className="bg-card rounded-t-2xl border-t border-x border-border/80 p-6 flex flex-col items-center relative shadow-[0_-10px_20px_-15px_rgba(0,0,0,0.1)] h-40 justify-end"
          >
            <div className="absolute -top-8 flex flex-col items-center">
              <div className="w-14 h-14 rounded-full bg-slate-200 border-4 border-amber-700/50 shadow-lg flex items-center justify-center text-muted-foreground font-bold text-lg overflow-hidden">
              ...
              <div className="w-7 h-7 rounded-full bg-amber-700/60 border-2 border-white flex items-center justify-center text-primary-foreground font-bold -mt-3 shadow-sm text-sm">3</div>
            </div>
            ...
            {loading ? (
              Array.from({ length: 5 }).map((_, i) => (
                <tr key={i} className="animate-pulse">
                  <td className="px-6 py-4"><div className="h-4 bg-muted rounded mx-auto w-4" /></td>
                  ...
                  <td className="px-6 py-4"><div className="h-4 bg-muted rounded mx-auto w-12" /></td>
                  <td className="px-6 py-4"><div className="h-4 bg-muted rounded mx-auto w-8" /></td>
                  <td className="px-6 py-4"><div className="h-4 bg-muted rounded mx-auto w-8" /></td>
                  <td className="px-6 py-4"><div className="h-4 bg-muted rounded mx-auto w-12" /></td>
                </tr>
              ))
              ...
              entries.map((entry, i) => (
                <tr key={entry.employee_id} className={`hover:bg-muted/50 transition-colors ${i < 3 ? 'bg-muted/50/30' : ''}`}>
