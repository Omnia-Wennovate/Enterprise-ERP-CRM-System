      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Training & LMS</h1>
              <p className="text-muted-foreground mt-1">Enterprise Learning Management System</p>
            </div>
          </div>

          <div className="flex items-center gap-1 bg-card p-1 rounded-xl shadow-sm border border-border overflow-x-auto no-scrollbar">
            {tabs.map(tab => {
              const Icon = tab.icon
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${
                    isActive 
                      ? 'bg-omnia-gold text-primary-foreground shadow-md shadow-teal-600/20' 
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {activeTab === 'reports' && (
            <div className="bg-card p-20 text-center rounded-xl border border-border">
              <BarChart2 className="w-12 h-12 text-slate-300 mx-auto mb-4" />
              <h2 className="text-xl font-bold text-foreground">Training Reports</h2>
