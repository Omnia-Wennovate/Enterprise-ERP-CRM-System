    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          <Link href="/hr/employees" className="p-2 hover:bg-card rounded-lg transition">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="bg-card rounded-lg shadow p-6">
            <p className="text-muted-foreground text-sm mb-2">Employee ID</p>
            <p className="text-2xl font-bold text-foreground">{employee.employee_id}</p>
          </div>
          <div className="bg-card rounded-lg shadow p-6">
            <p className="text-muted-foreground text-sm mb-2">Department</p>
            <p className="text-2xl font-bold text-foreground">{employee.department}</p>
          </div>
          <div className="bg-card rounded-lg shadow p-6">
            <p className="text-muted-foreground text-sm mb-2">Branch</p>
            <p className="text-2xl font-bold text-foreground">{employee.branch}</p>
          </div>
          <div className="bg-card rounded-lg shadow p-6">
            <p className="text-muted-foreground text-sm mb-2">Manager</p>
            <p className="text-xl font-bold text-foreground">{employee.manager_name}</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-lg shadow">
          ...
          <div className="p-8">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-3 gap-6">
                  <div className="bg-muted/50 rounded-lg p-4">
                    <p className="text-muted-foreground text-sm mb-1">Basic Salary</p>
                    <p className="text-2xl font-bold text-foreground">${employee.basic_salary}</p>
                  </div>
                  <div className="bg-muted/50 rounded-lg p-4">
            ...
            {activeTab === 'performance' && (
              <div className="space-y-6">
                <div>
                  <h3 className="font-semibold text-foreground mb-4">Recent Performance Reviews</h3>
                  <div className="space-y-3">
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-muted-foreground text-sm">KPI Score: 95% | Target: 85%</p>
                    </div>
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between mb-2">
                      ...
                      <p className="text-muted-foreground text-sm">KPI Score: 88% | Target: 85%</p>
                    </div>
                  </div>
                </div>
              </div>
