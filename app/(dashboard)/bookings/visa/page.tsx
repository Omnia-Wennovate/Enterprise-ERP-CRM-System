        ...
        {view !== 'detail' && (
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-500 mt-1 ml-14">Enterprise visa processing & intelligence</p>
            </div>
              ...
              <div className="flex items-center bg-white rounded-xl border border-slate-200 p-1">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-medium transition-all ${
                    view === 'dashboard' ? 'bg-teal-600 text-white shadow-sm' : 'text-slate-600 hover:bg-slate-50'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-medium transition-all ${
                    view === 'list' ? 'bg-teal-600 text-white shadow-sm' : 'text-slate-600 hover:bg-slate-50'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-medium transition-all ${
                    view === 'reports' ? 'bg-teal-600 text-white shadow-sm' : 'text-slate-600 hover:bg-slate-50'
                  }`}
                >
