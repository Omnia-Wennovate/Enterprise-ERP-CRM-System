  ...
  return (
    <div className="flex items-center gap-2">
      <motion.button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-blue-600/10 text-blue-600 border border-blue-200/50 dark:border-blue-800/50 rounded-xl text-sm font-medium hover:bg-blue-600/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
