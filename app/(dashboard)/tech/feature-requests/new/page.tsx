      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Submit Feature Request</h1>
              <p className="text-sm text-muted-foreground mt-1">Request a new feature or software improvement</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-3xl">
            <div className="bg-card rounded-xl border border-border shadow-sm p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-foreground mb-1">Desired Due Date</label>
                  <input
                    type="date"
                    value={form.due_date}
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-1">Estimated Effort</label>
                  <select
              ...
              {/* Business Impact */}
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Business Impact</label>
                <textarea
